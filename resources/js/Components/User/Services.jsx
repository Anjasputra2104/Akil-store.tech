                ...
                <div className="flex flex-wrap mt-16 gap-y-4">
                    <div className="w-full group sm:w-4/12 sm:-mx-4 sm:px-4">
                        <div className="flex gap-2 items-start">
                            <div className="bg-white rounded-full w-12 lg:w-14 h-12 relative">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="ionicon fill-primary w-6 transition-all duration-300 ease-in-out group-hover:w-7 absolute inset-1/2 -translate-x-1/2 -translate-y-1/2"
                                    viewBox="0 0 512 512"
                                >
